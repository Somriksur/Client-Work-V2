...
import channelsImage from '@/assets/services/content-marketing/content-marketing-channels.webp';
      ...
      <section className="relative w-full">
        ...
        <div className="absolute inset-0 flex items-start justify-center pt-12 md:pt-16 lg:pt-20 px-6 md:px-12 lg:px-20" style={{ paddingTop: 'calc(3rem + 110px)', marginLeft: '125px' }}>
          <div className="w-full max-w-lg">
            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-2 md:mb-3">
              {heading}
            </h2>
            
            <p className="text-gray-700 text-[10px] md:text-xs mb-3 md:mb-4">
              {intro}
            </p>
            
            <div className="space-y-1.5 md:space-y-2">
              <div className="flex items-start gap-2">
                <svg className="w-3 h-3 md:w-4 md:h-4 text-green-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                  <circle cx="12" cy="12" r="10" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4" />
                </svg>
                <p className="text-gray-900 text-[10px] md:text-xs">{channel1}</p>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-900 text-[10px] md:text-xs">{channel2}</p>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-900 text-[10px] md:text-xs">{channel3}</p>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-900 text-[10px] md:text-xs">{channel4}</p>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-900 text-[10px] md:text-xs">{channel5}</p>
              </div>
              ...
              <div className="flex items-start gap-2">
                ...
                <p className="text-gray-900 text-[10px] md:text-xs">{channel6}</p>
              </div>
            </div>
            
            <p className="text-gray-700 text-[10px] md:text-xs mt-3 md:mt-4">
              {outro}
            </p>
          </div>
        </div>
